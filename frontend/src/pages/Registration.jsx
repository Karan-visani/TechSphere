...
const Registration = () => {
  ...
  return (
    <div className=' min-h-[85vh] flex mx-10'>
            ...
            <p className='text-md text-gray-400 flex justify-start'>Join TechSphere today</p>
            </div>
            <div className='flex flex-col gap-4 items-center mt-3'>
            <div className='w-full flex flex-col gap-2'>
            <label className='text-lg ms-2 text-gray-200'>Name :</label>
            <input value={name} onChange={(e)=>{
              setName(e.target.value)
            }} className='border-2 border-slate-800 text-lg text-gray-300  rounded-2xl px-4 py-2 outline-none bg-slate-800 focus:border-blue-900 hover:border-blue-900 w-full' type="text" name="name" id="name" placeholder='Enter your name'/>    
            </div>
            <div className='w-full flex flex-col gap-2'>
            ...
            <button type='submit' className='text-lg bg-blue-600 w-[70%] rounded-lg p-2 hover:scale-105 mt-3 font-semibold'>Create Account</button> 
            <p className='text-md text-gray-200 font-medium'>Already have an account? <Link to={"login"} className='text-blue-500 hover:text-blue-700'>Log In</Link></p> 
